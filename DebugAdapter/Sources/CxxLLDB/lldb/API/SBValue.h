...
public:
  ...
  const char *GetTypeName() SWIFT_RETURNS_INDEPENDENT_VALUE;
  ...
  const char *GetValue() SWIFT_RETURNS_INDEPENDENT_VALUE;
  ...
  const char *GetSummary() SWIFT_RETURNS_INDEPENDENT_VALUE;

  const char *GetSummary(lldb::SBStream &stream,
                         lldb::SBTypeSummaryOptions &options) SWIFT_RETURNS_INDEPENDENT_VALUE;

  const char *GetObjectDescription() SWIFT_RETURNS_INDEPENDENT_VALUE;
