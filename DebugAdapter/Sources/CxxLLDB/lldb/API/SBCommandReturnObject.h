...
public:
  ...
  const char *GetError() SWIFT_RETURNS_INDEPENDENT_VALUE;
  ...
  const char *GetOutput(bool only_if_no_immediate) SWIFT_RETURNS_INDEPENDENT_VALUE;

  const char *GetError(bool only_if_no_immediate) SWIFT_RETURNS_INDEPENDENT_VALUE;
