...
public:
  ...
  const char *GetURL() SWIFT_RETURNS_INDEPENDENT_VALUE;
  ...
  const char *GetLocalCacheDirectory() SWIFT_RETURNS_INDEPENDENT_VALUE;
...
public:
  ...
  const char *GetShell() SWIFT_RETURNS_INDEPENDENT_VALUE;

  void SetShell(const char *shell);

  const char *GetCommand() SWIFT_RETURNS_INDEPENDENT_VALUE;

  void SetCommand(const char *shell_command);

  const char *GetWorkingDirectory() SWIFT_RETURNS_INDEPENDENT_VALUE;
  ...
  const char *GetOutput() SWIFT_RETURNS_INDEPENDENT_VALUE;
...
public:
  ...
  const char *GetTriple() SWIFT_RETURNS_INDEPENDENT_VALUE;

  const char *GetHostname() SWIFT_RETURNS_INDEPENDENT_VALUE;

  const char *GetOSBuild() SWIFT_RETURNS_INDEPENDENT_VALUE;

  const char *GetOSDescription() SWIFT_RETURNS_INDEPENDENT_VALUE;
